  ...
  const handleDeletar = (id) => {
    ...
    <Card>
        ...
        <CardContent>
            ...
            <Table sx={{ minWidth: 650, background: '#ffe' }} size="small" aria-label="a dense table">
                <TableHead>
                <TableRow>
                    <TableCell>#</TableCell>
        ...
        <CardActions>
            <Button size="small" variant="contained" onClick={handleOpen} sx={{background: '#aaa'}}>Criar Tarefa</Button>
            <Button size="small" variant="outlined" sx={{background: '#aaf'}}>Cancelar</Button>
      </CardActions> 
    </Card>
    <div>
      <Modal
